...
import { FaSave, FaUpload, FaTags, FaEye, FaAngleDown, FaGlobe, FaCompress, FaExpand, FaTrash } from 'react-icons/fa';
...
const BlogEditPage = () => {
  ...
  const fetchBlog = async () => {
    try {
      ...
      setIsPublished(blogData.isPublished !== false);
      setSlug(blogData.slug || '');
      setReadTime(blogData.readTime || 5);
      
      // SEO data
      if (blogData.seo) {
        setSeoTitle(blogData.seo.metaTitle || '');
        setSeoDescription(blogData.seo.metaDescription || '');
        setSeoKeywords(blogData.seo.keywords ? blogData.seo.keywords.join(', ') : '');
      }
